...
VALUES 
('João', 'Silva', 'joao.silva@email.com', '123456789', '(00) 1234-5678', '12345-678', 'Rua horizonte', 'Apartamento 101', '1990-05-15', 'Macaco gold team', 'preta', '1°', 80.0, 'Campeão regional de Jiu-Jitsu'),
('Maria', 'Santos', 'maria.santos@email.com', '123456789', '(00) 9876-5432', '54321-876', 'Avenida paulista', 'apartamento 1220', '1988-10-20', 'Alpha', 'azul', '2°', 65.5, 'Participante em torneios estaduais de Jiu-Jitsu'),
('Pedro', 'Souza', 'pedro.souza@email.com', '123456789', '(00) 4567-8901', '98765-432', 'Rua Cristovão', 'Bloco D', '1995-03-10', 'Ryan gracie', 'marrom', '3°', 75.3, 'Instrutor de Jiu-Jitsu');

INSERT INTO atleta (nome, sobrenome, email, senha, telefone, cep, logradouro, complemento, dtNasc, team, faixa, grau, peso, descricao) 
VALUES 
('Carlos', 'Pereira', 'carlos.pereira@email.com', 'senhaSegura1', '(00) 1122-3344', '12345-987', 'Rua das Flores', 'Casa 10', '1985-07-22', 'BJJ Heroes', 'roxa', '2°', 78.9, 'Vice-campeão nacional de Jiu-Jitsu'),
('Ana', 'Lima', 'ana.lima@email.com', 'senhaSegura2', '(00) 2233-4455', '54321-654', 'Avenida Central', 'Conjunto 200', '1992-11-30', 'Top Team', 'verde', '1°', 63.2, 'Treinadora de Jiu-Jitsu infantil'),
('Lucas', 'Martins', 'lucas.martins@email.com', 'senhaSegura3', '(00) 3344-5566', '67890-123', 'Rua das Palmeiras', 'Apartamento 3B', '1989-04-17', 'Warriors', 'azul', '3°', 82.1, 'Campeão universitário de Jiu-Jitsu'),
('Beatriz', 'Oliveira', 'beatriz.oliveira@email.com', 'senhaSegura4', '(00) 4455-6677', '87654-321', 'Avenida das Nações', 'Bloco A', '1991-12-25', 'Elite Team', 'branca', '1°', 55.8, 'Iniciando carreira no Jiu-Jitsu'),
('Gabriel', 'Fernandes', 'gabriel.fernandes@email.com', 'senhaSegura5', '(00) 5566-7788', '13579-246', 'Rua do Campo', 'Sítio São José', '1987-06-18', 'Champion BJJ', 'preta', '5°', 90.7, 'Campeão mundial de Jiu-Jitsu'),
('Julia', 'Costa', 'julia.costa@email.com', 'senhaSegura6', '(00) 6677-8899', '24680-135', 'Rua da Liberdade', 'Apartamento 404', '1994-08-05', 'Gracie Barra', 'marrom', '4°', 68.4, 'Treinadora de Jiu-Jitsu avançado'),
('Rafael', 'Rodrigues', 'rafael.rodrigues@email.com', 'senhaSegura7', '(00) 7788-9900', '11223-334', 'Avenida da Paz', 'Condomínio Sol', '1993-09-14', 'Nova União', 'roxa', '3°', 75.9, 'Atleta de Jiu-Jitsu profissional'),
('Sofia', 'Almeida', 'sofia.almeida@email.com', 'senhaSegura8', '(00) 8899-0011', '33445-667', 'Rua do Sol', 'Apartamento 202', '1996-02-28', 'Alliance', 'azul', '2°', 62.0, 'Participante em campeonatos internacionais de Jiu-Jitsu'),
('Vinicius', 'Carvalho', 'vinicius.carvalho@email.com', 'senhaSegura9', '(00) 9900-1122', '44556-778', 'Avenida das Américas', 'Casa 5', '1990-01-12', 'CheckMat', 'verde', '1°', 80.2, 'Promissor atleta de Jiu-Jitsu'),
('Larissa', 'Barbosa', 'larissa.barbosa@email.com', 'senhaSegura10', '(00) 0011-2233', '55667-889', 'Rua das Estrelas', 'Bloco B', '1986-03-23', 'GFTeam', 'preta', '4°', 65.7, 'Instrutora de Jiu-Jitsu para mulheres');
...
select * from postagem order by dtPostagem desc;
