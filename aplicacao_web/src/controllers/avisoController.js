...
//listarPesquisa
function listarPostUser(req, res) {

    var idAtleta = req.params.idAtleta;

    avisoModel.listarPostUser(idAtleta).then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function listarPesquisa(req, res) {
    ...
    avisoModel.listarPesquisa(idAtleta).then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function listarInfoAtletas(req, res) {

    var idAtleta = req.params.idAtleta;

    avisoModel.listarInfoAtletas(idAtleta).then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function publicar(req, res) {
    ...
    if (titulo == undefined) {
        ...
        avisoModel.publicar(titulo, descricao, idAtleta)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
